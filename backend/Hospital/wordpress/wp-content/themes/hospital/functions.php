...
function hospital_widgets_init() {
	register_sidebar( array(
		'name'          => esc_html__( 'Sidebar', 'hospital' ),
		'id'            => 'sidebar-1',
...
function hospital_scripts() {
	wp_enqueue_style( 'hospital-style', get_stylesheet_uri() );

	wp_enqueue_script('MainJquery', get_template_directory_uri() . '/js/jquery.min.js', array(), 'null', true );

	wp_enqueue_script('carousel', get_template_directory_uri() . '/js/owl.carousel.min.js', array(), 'null', true );

	wp_enqueue_script('quant', get_template_directory_uri() . '/js/quant-lib.js', array(), 'null', true );

	wp_enqueue_script('baseButton',get_template_directory_uri() . '/js/baseButton.js', array(), 'null', true );

	wp_enqueue_script('XRAY', get_template_directory_uri() . '/js/xRayView.js', array(), 'null', true );

	wp_enqueue_script('init', get_template_directory_uri() . '/js/init.js', array(), 'null', true );



	wp_enqueue_script( 'hospital-navigation', get_template_directory_uri() . '/js/navigation.js', array(), '20151215', true );
